# Before / After — quick-start-3-wins

## Listing description (Prompt 1)
...
## Counter-offer reply (Prompt 2)

**Before** (most agents at 9 PM after a long day):

> Hi Sarah, Thanks for sending the counter. We've reviewed and unfortunately my buyer can't go higher than the original offer. They are a young couple just starting out and this is the absolute max they qualified for! Please let them know if your seller is willing to accept. Thanks!

What just happened:
- "Young couple just starting out" — demographic disclosure, FHA-adjacent.
- "Absolute max they qualified for" — leaks buyer's financing ceiling, terrible negotiating position.
- "Please let them know" — passive, weak.
- No flex on terms — leaves the negotiation closed.

**After** (Prompt 2):

> Hi Sarah, thanks for the quick turnaround on that counter. My buyer is going to hold at the original offer on price. We can flex on the close date — they have flexibility from June 1 through end of June if a longer runway helps your seller. We are also fine leaving all the appliances. Looking forward to your seller's response — I think we are within reach. — Al

6 sentences. Holds price. Flexes on close date + appliances (terms the buyer doesn't care about). Collegial. Leaves room for one more counter. No demographic disclosure. No financing-ceiling leak.

## 3 social posts (Prompt 3)
...
- "Great schools nearby" — FHA.
- "Family-friendly" — FHA demographic.
- "#DreamHome" — banned cliché.
- One platform only; no FB or TikTok versions.
...
## Time saved on a single listing

Manual: 45-60 min (description + 3 social posts + counter-offer reply, all from blank screens).
With this skill: 8-12 min.

Across 12 listings/year, that's 7-10 hours back per agent. The 3 wins are called "wins" because each one is a tangible, shippable, today thing.
